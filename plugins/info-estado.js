...
const handler = async (m, { conn, usedPrefix }) => {
  ...
  ${tradutor.texto1[1]} 𝐋𝐞𝐥𝐞𝟕𝐛𝐨𝐭
  ${tradutor.texto1[2]} +56985281325
  ${tradutor.texto1[3]} https://www.instagram.com/letelier7.dsng
  ...
  const Message = {
    document: { url: `https://www.instagram.com/letelier7.dsng/TheMystic-Bot-MD` },
    ...
    contextInfo: {
      ...
      isForwarded: true,
      externalAdReply: {
        mediaUrl: "https://www.instagram.com/letelier7.dsng/TheMystic-Bot-MD",
        mediaType: 2,
        previewType: "pdf",
        title: "𝐋𝐞𝐥𝐞𝟕𝐛𝐨𝐭",
        body: tradutor.texto2,
        thumbnail: imagen1,
        sourceUrl: "https://www.instagram.com/letelier7.dsng/TheMystic-Bot-MD",
      },
    },
    caption: info,
    footer: wm,
